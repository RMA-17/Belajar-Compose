package com.rmaproject.mytempratureconverter
...
import com.rmaproject.mytempratureconverter.ui.theme.MyTempratureConverterTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            MyTempratureConverterTheme {
                Surface(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = { newText ->
                input = newText
                output = convertToFahrenheit(newText)
            }
        )
        Text(
...
fun StatelessTemperatureInput(
    ...
    Column(modifier.padding(8.dp)) {
        Text(
            stringResource(id = R.string.stateless_converter),
            style = MaterialTheme.typography.h5
        )
        OutlinedTextField(
            value = input,
    ...
    Column(modifier.padding(16.dp)) {
        ...
        GeneralTemperatureInput(
            ...
            onValueChange = { newValue ->
                celsius = newValue
                fahrenheit = convertToFahrenheit(newValue)
            }
        )
        GeneralTemperatureInput(
            ...
            onValueChange = { newValue ->
                fahrenheit = newValue
                celsius = convertToCelsius(newValue)
            }
        )
    }
}
